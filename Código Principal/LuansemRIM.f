...
261   CONTINUE
	...
	REAL*8 G(NX,NX),H(NX,NX),H1,H2,G1,G2,GG1,GG2
	REAL*8 TA,RA,C(NX,NX)
	REAL*8 P(NX,NX)
...
!*****************FORMAÇÃO DAS MATRIZES H, G E DO TERMO INDEPENDENTE HGK TIPO GALERKIN******************
 ...
 10   CONTINUE
  	...
  	DO 12 I=1,NP ! Nº PONTOS FONTE (SOMENTE PTS DO CONTORNO AQUI)
		...
		CALL INTE(X(I),Y(I),XX(L1),YY(L1),XX(L2),YY(L2),
	*H1,H2,G1,G2,HG1,HG2,GG1,GG2)
C		CALL GALERK1(X(I),Y(I),XX(L1),YY(L1),XX(L2),YY(L2),
C     *HG1,HG2,GG1,GG2)
		H(I,L2)=H(I,L2)+H2
		H(I,L1)=H(I,L1)+H1
		G(I,L2)=G(I,L2)+G2
...
C	INTRODUÇÃO DE PONTOS INTERNOS CONSTITUTIVOS	- PONTOS FONTE - EM H E G
	...
	CALL INTE(X(I),Y(I),XX(L1),YY(L1),XX(L2),YY(L2),
	*H1,H2,G1,G2,HG1,HG2,GG1,GG2)
C      CALL INTE(X(I),Y(I),XX(L1),YY(L1),XX(L2),YY(L2),H1,H2,G1,G2,            !CALCULO DA INTEGRAL H E G
C     *DX1,DX2,DY1,DY2,EX1,EX2,EY1,EY2)
C      CALL GALERK1(X(I),Y(I),XX(L1),YY(L1),XX(L2),YY(L2),HG1,HG2,
C     *GG1,GG2)     !CALCULO DA INTEGRAL W E S
 	H(I,L2)=H(I,L2)+H2
      H(I,L1)=H(I,L1)+H1
      G(I,L2)=G(I,L2)+G2
      G(I,L1)=G(I,L1)+G1
...
3102			CONTINUE
			...
			TERM_QQ_5(I,J)=TERM_QQ_5(I,J)+TERM_QU_5(I,J)*CCUQ(K,J)  !VM
...
C3104	CONTINUE
	...
	DO 3200 I=1,JQQ
	DO 3201 J=1,JQQ
C	MATRIZA_LINHA(I+0*JQQ,J+0*JQQ)=0								!0
	MATRIZA_LINHA(I+0*JQQ,J+1*JQQ)=(TERM_QQ_9(I,J)-TERM_QQ_10(I,J)	!MATRIZ D
	&+TERM_QQ_11(I,J)-CCQQ(I,J))	
C	MATRIZA_LINHA(I+0*JQQ,J+2*JQQ)=0								!0
C	MATRIZA_LINHA(I+0*JQQ,J+3*JQQ)=0								!0

	MATRIZA_LINHA(I+1*JQQ,J+0*JQQ)=(TERM_QQ_12(I,J))				!MATRIZ E
	MATRIZA_LINHA(I+1*JQQ,J+1*JQQ)=(TERM_QQ_9(I,J)-TERM_QQ_10(I,J)	!MATRIZ D
	&+TERM_QQ_11(I,J)-CCQQ(I,J))										!...
	MATRIZA_LINHA(I+1*JQQ,J+2*JQQ)=(WQQ(I,J)+TERM_QQ_5(I,J)			!MATRIZ C
	&-TERM_QQ_6(I,J)-TERM_QQ_7(I,J)-TERM_QQ_8(I,J))					!...
	MATRIZA_LINHA(I+1*JQQ,J+3*JQQ)=(HQQ(I,J)-TERM_QQ_2(I,J)			!MATRIZ B
	&-TERM_QQ_3(I,J)-TERM_QQ_4(I,J))								

C	MATRIZA_LINHA(I+2*JQQ,J+0*JQQ)=0								!0
C	MATRIZA_LINHA(I+2*JQQ,J+1*JQQ)=0								!0
	MATRIZA_LINHA(I+2*JQQ,J+2*JQQ)=(WQQ(I,J)+TERM_QQ_5(I,J)			!MATRIZ C
	&-TERM_QQ_6(I,J)-TERM_QQ_7(I,J)-TERM_QQ_8(I,J))					!...
C	MATRIZA_LINHA(I+2*JQQ,J+3*JQQ)=0								!0

C	MATRIZA_LINHA(I+3*JQQ,J+0*JQQ)=0								!0
C	MATRIZA_LINHA(I+3*JQQ,J+1*JQQ)=0								!0
C	MATRIZA_LINHA(I+3*JQQ,J+2*JQQ)=0								!0
	MATRIZA_LINHA(I+3*JQQ,J+3*JQQ)=(HQQ(I,J)-TERM_QQ_2(I,J)			!MATRIZ B
	&-TERM_QQ_3(I,J)-TERM_QQ_4(I,J))								


	MATRIZB_LINHA(I+0*JQQ,J+0*JQQ)=(TERM_QQ_9(I,J)-TERM_QQ_10(I,J)	!MATRIZ D
	&+TERM_QQ_11(I,J)-CCQQ(I,J))
...
C	MATRIZB_LINHA(I+1*JQQ,J+2*JQQ)=0
	MATRIZB_LINHA(I+1*JQQ,J+3*JQQ)=-(TERM_QQ_1(I,J))				!MATRIZ A
C	WRITE(*,*) 'MATRIZB_LINHA(',I+1*JQQ,',',J+3*JQQ,')=',
C	&MATRIZB_LINHA(I+1*JQQ,J+3*JQQ)

C	MATRIZB_LINHA(I+2*JQQ,J+0*JQQ)=0
	MATRIZB_LINHA(I+2*JQQ,J+1*JQQ)=(WQQ(I,J)+TERM_QQ_5(I,J)			!MATRIZ C
	&-TERM_QQ_6(I,J)-TERM_QQ_7(I,J)-TERM_QQ_8(I,J))					!MATRIZ C
...
C	MATRIZB_LINHA(I+3*JQQ,J+1*JQQ)=0
	MATRIZB_LINHA(I+3*JQQ,J+2*JQQ)=(HQQ(I,J)-TERM_QQ_2(I,J)			!MATRIZ B
	&-TERM_QQ_3(I,J)-TERM_QQ_4(I,J))									!MATRIZ B
